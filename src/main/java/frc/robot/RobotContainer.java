...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        joystick.touchpad().and(joystick.triangle()).whileTrue(drivetrain.sysIdDynamic(Direction.kForward));
        joystick.touchpad().and(joystick.square()).whileTrue(drivetrain.sysIdDynamic(Direction.kReverse));
